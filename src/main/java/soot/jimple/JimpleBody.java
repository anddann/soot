...
//          IdentityValidator.v(), MethodValidator.v()
     ...
     */
    public JimpleBody(SootMethod m, Printer myPrinter, Options myOptions) {
        super(m, myOptions, myPrinter);
    }

    public JimpleBody(Printer myPrinter, Options myOptions) {
     ...
     * @param myOptions
     */
    public JimpleBody(Body body, Options myOptions, Printer myPrinter) {
    ...
    @Override
    public Object clone() {
        Body b = new JimpleBody(getMethod(), super.getMyPrinter(), super.getMyOptions());
