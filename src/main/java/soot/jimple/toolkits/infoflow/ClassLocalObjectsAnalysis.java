...
public class ClassLocalObjectsAnalysis {
  ...
  public ClassLocalObjectsAnalysis(LocalObjectsAnalysis loa, InfoFlowAnalysis dfa, UseFinder uf, SootClass sootClass, Scene myScene, ThrowAnalysis throwAnalysis, Options myOptions, ThrowableSet.Manager myManager, PhaseDumper myPhaseDumper) {
    this(loa, dfa, null, uf, sootClass, null,  myScene, throwAnalysis, myOptions, myManager, myPhaseDumper);
  }

  public ClassLocalObjectsAnalysis(LocalObjectsAnalysis loa, InfoFlowAnalysis dfa, InfoFlowAnalysis primitiveDfa,
                                   UseFinder uf, SootClass sootClass, List<SootMethod> entryMethods, Scene myScene, ThrowAnalysis throwAnalysis, Options myOptions, ThrowableSet.Manager myManager, PhaseDumper myPhaseDumper) {
