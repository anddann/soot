...
public class NativeMethodDriver {
  ...
  public NativeMethodDriver(NativeHelper helper, Environment myEnvironment) {
    ...
    cnameToSim.put("java.lang.String", new JavaLangStringNative(helper, myEnvironment));
    ...
    cnameToSim.put("java.lang.Class", new JavaLangClassNative(helper, myEnvironment));
    cnameToSim.put("java.lang.Package", new JavaLangPackageNative(helper, myEnvironment));
    cnameToSim.put("java.lang.Thread", new JavaLangThreadNative(helper, myEnvironment));
    ...
    cnameToSim.put("java.lang.SecurityManager", new JavaLangSecurityManagerNative(helper, myEnvironment));
    ...
    cnameToSim.put("java.io.FileSystem", new JavaIoFileSystemNative(helper, myEnvironment));
    ...
    cnameToSim.put("java.util.TimeZone", new JavaUtilTimeZoneNative(helper, myEnvironment));

    cnameToSim.put("java.util.jar.JarFile", new JavaUtilJarJarFileNative(helper, myEnvironment));
    ...
    cnameToSim.put("java.security.AccessController", new JavaSecurityAccessControllerNative(helper, myEnvironment));
