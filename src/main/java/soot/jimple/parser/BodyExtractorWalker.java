...
public class BodyExtractorWalker extends Walker {
     ...
     */
    public BodyExtractorWalker(SootClass sc, SootResolver resolver, Map<SootMethod, JimpleBody> methodToParsedBodyMap, ConstantFactory constantFactory, Scene myScene, Options myOptions, PackageNamer myPackageNamer, Printer myPrinter) {
        super(sc, constantFactory, resolver, myScene, myOptions, myPackageNamer, myPrinter);
    ...
    public void outAMethodMember(AMethodMember node) {
        ...
        if (sm.isConcrete() && methodBody != null) {
            ...
            if (sm.isPhantom() && myOptions.verbose()) {
