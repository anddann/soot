...
public class Walker extends DepthFirstAdapter {
  ...
  public Walker(ConstantFactory constantFactory, SootResolver resolver, Scene myScene, Options myOptions, PackageNamer myPackageNamer, Printer myPrinter) {
    ...
    public Walker(SootClass sc, ConstantFactory constantFactory, SootResolver resolver, Scene myScene, Options myOptions, PackageNamer myPackageNamer, Printer myPrinter) {
        mSootClass = sc;
        this.constantFactory = constantFactory;
        mResolver = resolver;
        this.myScene = myScene;
    ...
    public void outAFullMethodBody(AFullMethodBody node) {
        JimpleBody jBody = Jimple.newBody(myPrinter, myOptions);
    ...
    public void outACatchClause(ACatchClause node) {
        ...
        Trap trap = Jimple.newTrap(mResolver.makeClassRef(exceptionName), fromUnit, toUnit, withUnit);
    ...
    public void outATableswitchStatement(ATableswitchStatement node) {
        ...
        Unit switchStmt = Jimple.newTableSwitchStmt(key, lowIndex, highIndex, targets, defaultTarget);
    ...
    public void outALookupswitchStatement(ALookupswitchStatement node) {
        ...
        Value key = (Value) mProductions.removeLast();
        Unit switchStmt = Jimple.newLookupSwitchStmt(key, lookupValues, targets, defaultTarget, constantFactory);
    ...
    public void outAIdentityNoTypeStatement(AIdentityNoTypeStatement node) {
        ...
        Unit u = Jimple.newIdentityStmt(local, Jimple.newCaughtExceptionRef(myScene));
        mProductions.addLast(u);
    }
    ...
    public void outAInstanceofExpression(AInstanceofExpression node) {
        ...
        Value immediate = (Value) mProductions.removeLast();
        mProductions.addLast(Jimple.newInstanceOfExpr(immediate, nonvoidType));
    ...
    public void outADynamicInvokeExpr(ADynamicInvokeExpr node) {
        ...
        mProductions.addLast(Jimple.newDynamicInvokeExpr(bsmMethodRef, bsmArgs, dynMethodRef, dynArgs));
    }
    ...
    public void outASimpleNewExpr(ASimpleNewExpr node) {
        mProductions.addLast(Jimple.newNewExpr((RefType) mProductions.removeLast()));
    }
