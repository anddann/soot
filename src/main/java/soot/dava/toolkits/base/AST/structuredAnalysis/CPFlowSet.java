...
public class CPFlowSet extends DavaFlowSet<CPTuple> {
    ...
    public CPFlowSet(ClosestAbruptTargetFinder myClosestAbruptTargetFinder) {
     ...
     * is being cloned!!!
     */
    public CPFlowSet(CPFlowSet other, ClosestAbruptTargetFinder myClosestAbruptTargetFinder) {
    ...
    public void intersection(FlowSet otherFlow, FlowSet destFlow) {
        ...
        if (dest == other || dest == this) {
            workingSet = new CPFlowSet(myClosestAbruptTargetFinder);
        } else {
            workingSet = dest;
            workingSet.clear();
        }
    ...
    public CPFlowSet clone() {
        ...
        return new CPFlowSet(this, myClosestAbruptTargetFinder);
    }
