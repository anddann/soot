...
public class SimplifyConditions extends DepthFirstAdapter {
  ...
  public SimplifyConditions(ConstantFactory constancFactory, PrimTypeCollector primTypeCollector) {
    super();
    this.constancFactory = constancFactory;
    this.primTypeCollector = primTypeCollector;
  }

  public SimplifyConditions(boolean verbose, ConstantFactory constancFactory, PrimTypeCollector primTypeCollector) {
    super(verbose);
    this.constancFactory = constancFactory;
    this.primTypeCollector = primTypeCollector;
  }
