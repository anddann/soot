...
public class GrimpBody extends StmtBody {
    ...
    GrimpBody(SootMethod m, Options myOptions, Printer myPrinter, ConstantFactory constantFactory) {
    ...
    GrimpBody(Body body, Options myOptions, Printer myPrinter, PackManager myPackManager, ConstantFactory constantFactory) {
        ...
        while (it.hasNext()) {
            ...
            while (useBoxesIt.hasNext()) {
                ...
                b.setValue(Grimp.newExpr(b.getValue(), this.constantFactory));
            }
        ...
        while (trapIt.hasNext()) {
            ...
            getTraps().add(Grimp.newTrap(oldTrap.getException(), (oldToNew.get(oldTrap.getBeginUnit())),
