...
public abstract class Pack implements HasPhaseOptions, Iterable<Transform> {
  ...
  public PhaseOptions getMyPhaseOptions() {
  ...
  public Pack(String name, PhaseOptions myPhaseOptions) {
    this.name = name;
  ...
  public void add(Transform t) {
    ...
    myPhaseOptions.getPM().notifyAddPack();
  ...
  public final void apply() {
    Map<String, String> options = myPhaseOptions.getPhaseOptions(this);
