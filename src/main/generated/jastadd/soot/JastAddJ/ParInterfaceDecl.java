...
/**
 * @production ParInterfaceDecl : {@link InterfaceDecl} ::= <span class="component">Argument:{@link Access}*</span>
 *             <span class="component">SuperInterfaceId:{@link Access}*</span>
...
public class ParInterfaceDecl extends InterfaceDecl implements Cloneable, ParTypeDecl, MemberSubstitutor {
   ...
   * 
   */
  public ParInterfaceDecl(Scene myScene, Jimple myJimple, SootResolver mySootResolver, PackageNamer myPackageNamer,
   ...
   * 
   */
  public ParInterfaceDecl(Modifiers p0, String p1, List<Access> p2, Scene myScene, Jimple myJimple,
      SootResolver mySootResolver, PackageNamer myPackageNamer, Options myOptions, PrimTypeCollector primTypeCollector,
   ...
   * 
   */
  public ParInterfaceDecl(Modifiers p0, beaver.Symbol p1, List<Access> p2, Scene myScene, Jimple myJimple,
      SootResolver mySootResolver, PackageNamer myPackageNamer, Options myOptions, PrimTypeCollector primTypeCollector,
      ConstantFactory constantFactory, PhaseOptions myPhaseOptions) {
   ...
   * 
   * @param list
   *          The new list node to be used as the SuperInterfaceId list.
   * @apilevel high-level
   * @ast method
   * 
   */
