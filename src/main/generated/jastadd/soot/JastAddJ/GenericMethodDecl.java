...
* @attribute syn
  ...
  boolean isFinal = this.is$Final();
    ...
    if(lookupParMethodDecl_java_util_List_list == null) {
      lookupParMethodDecl_java_util_List_list = new List(myScene, myOptions, myPackageNamer, myJimple, primTypeCollector, constantFactory, mySootResolver, myPhaseOptions);
