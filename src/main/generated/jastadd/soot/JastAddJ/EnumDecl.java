...
public class EnumDecl extends ClassDecl implements Cloneable {
  ...
  /*
   * 9) Nested enum types are implicitly static. It is permissable to explicitly declare a nested enum type to be static.
   * 
   * @attribute syn
   * 
   * @aspect Enums
   ...
   *
   * It is a compile-time error for an enum type E to have an abstract method m as a member unless E has one or more enum
   * constants, and all of E's enum constants have class bodies that provide concrete implementations of m.
   * 
   * @attribute syn
   * @aspect Enums
